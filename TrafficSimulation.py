...
def plot_list_of_density_graphs(list_of_density_lists, time_list, label_list):
    fig, ax = plt.subplots()
    ...
    ax.set(xlabel='time (s)', ylabel='density (num cars / ft)',
           title="Density of roads over time",)
...
def main():
    ...
    traffic_coef_list = dict_traffic_coef["medium"]
    traffic_simulation_with_plots(c_coef=traffic_coef_list[0], d_coef=traffic_coef_list[1], h_coef=traffic_coef_list[2])
